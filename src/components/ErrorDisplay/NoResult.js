...
import { mockupRes } from "@/stores/useCode";
  ...
  return (
    <div className="w-full h-full flex flex-col items-center ">
      <div className="w-full text-center p-8">
        ...
        {anaStat === 1 && isChecking && (
          <div className="p-10 border rounded-lg">
            <div className="px-10">Smart contract code loaded!</div>
        ...
        {anaStat === 1 && !isChecking && (
          <div className="p-10 border rounded-lg">
            Smart contract code loaded!
          </div>
        )}

        {anaStat === 2 && isChecking && (
          <div className="p-10 border rounded-lg">
            <div className="px-10">Your contract are being analyzed!</div>
            <div className="p-10 mt-5">
              <LinearProgress
                color="primary"
                fourColor
